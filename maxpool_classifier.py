...
def cnn_simple(input_layer):
    ...
    x = tf.keras.layers.Dropout(0.3)(x)  # Aumentar el Dropout
...
def lstm_function(input_layer):
    ...
    lstm_output = LSTM(100, return_sequences=False, kernel_regularizer=l2(0.001))(lstm_input)
...
optimizer = tf.keras.optimizers.Adam(learning_rate=6.2500e-05)
